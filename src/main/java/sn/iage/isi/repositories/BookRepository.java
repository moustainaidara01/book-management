...
public class BookRepository {
    ...
    public Book createBook(Book book) {
        ...
        // Si aucun ISBN n'est fourni, on en génère un automatiquement
    ...
    public List<Book> ListeBooksByCategory(String categoryName) {
        return em.createQuery(
                        "SELECT b FROM Book b WHERE b.category.name = :categoryName ORDER BY b.title",
                        Book.class)
    ...
    public int countAllBooks() {
        return em
                .createQuery("SELECT COUNT(b.id) FROM Book b", Integer.class)
                .getSingleResult();
    }
